            ...
            {HairData.map((elem)=>{
                return (
                    <Box key={elem.id} className="HairPageSimpleGridBox" w={{base : '95%', md : '90%'}} textAlign='center'  fontWeight={'550'} shadow='sm'>
                       ...
                       <Link to={`/Hair/${elem.id}`}> <Text h={{base : '85px', md : '85px', lg : '40px'}} w={{base : '90%', md : '90%', lg : '80%'}} m='auto' fontSize={{base : '12px', md : '14px'}} color='RGBA(0, 0, 0, 0.48)'>{elem.title}</Text></Link>
